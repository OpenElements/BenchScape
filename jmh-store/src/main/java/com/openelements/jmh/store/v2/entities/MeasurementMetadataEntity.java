...
@Entity
public class MeasurementMetadataEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(measurementId, that.measurementId)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, measurementId, gitOriginUrl, gitBranch, gitCommitId, gitTags, gitDirty, jmhThreadCount,
