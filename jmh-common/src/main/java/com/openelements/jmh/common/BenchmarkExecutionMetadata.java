 ...
 */
public record BenchmarkExecutionMetadata(@NonNull Instant startTime, @NonNull Instant warmupTime, @NonNull Instant measurementTime, @NonNull Instant stopTime,
