 ...
 */
public record BenchmarkExecution(@NonNull String benchmarkName, @NonNull BenchmarkType type, @NonNull BenchmarkInfrastructure infrastructure,
                                 @NonNull BenchmarkConfiguration configuration, @NonNull BenchmarkExecutionMetadata execution, @NonNull BenchmarkExecutionResult result) {
