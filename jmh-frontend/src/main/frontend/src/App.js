      ...
      <div className="bg-primary-gray">
        <div>
                ...
                <div
                  ...
                  <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                      ...
                      <li>
                        <div
                            class="text-xs font-semibold leading-6 text-gray-400">Your
                          teams
                        </div>
          ...
          <div
            ...
            <div
                class="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-navy pb-4 px-8">
          ...
          <div class="lg:pl-72 h-[calc(100vh-96px)]">
            <div class="sticky top-0 z-40 px-4 sm:px-6 xl:px-7 xl:py-5">
              ...
              <div
                  className="flex items-center h-14 bg-white rounded-lg shadow-lg sm:gap-x-6 gap-x-4">
                <button type="button"
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                  <div className="flex-1 flex items-center px-8">
                    <div className="flex items-center gap-5 h-full">
                      ...
                      <div>
                        <button
                            className="inline-flex items-center gap-2 text-primary-navy text-sm">
                          Menu Button
                          <CaretDown className="w-3 h-3 text-primary-navy"
                                     weight="fill"/>
                        </button>
                      </div>
                      <div className='w-0.5 h-4 bg-primary-navy/10'></div>
                  ...
                  <div class="flex items-center gap-5 px-8">
                    <div className="flex items-center gap-3">
                      <div
                          className="w-8 h-8 border-2 border-highlight-blue rounded-full overflow-hidden">
                    ...
                    <div className='w-0.5 h-4 bg-primary-navy/10'></div>
                    <button
                        className="text-primary-navy hover:text-red-600 transition-colors ease-in-out duration-150">
                      ...
                      <div class="px-4 sm:px-6 lg:px-8 py-7">
                        <div class="sm:flex sm:items-center">
                          <div class="sm:flex-auto">
                            <h1 class="text-xl font-semibold leading-6 text-primary-navy">BenchScape
                              V1.1</h1>
                          ...
                          <div
                            ...
                            <div
                              ...
                              <table
                                ...
                                <tr>
                                  <th scope="col"
                                      class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-primary-navy sm:pl-6 lg:pl-8">ID
                                  </th>
                                  <th scope="col"
                                      class="px-3 py-3.5 text-left text-sm font-semibold text-primary-navy">Name
                                  </th>
                                  <th scope="col"
                                      class="relative py-3.5 pl-3 pr-4 sm:pr-6 lg:pr-8 text-sm font-semibold text-primary-navy">Unit
                                  </th>
                                </tr>
                                </thead>
                                <tbody
